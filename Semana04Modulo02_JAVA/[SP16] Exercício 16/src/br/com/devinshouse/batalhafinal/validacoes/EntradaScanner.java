...
public class EntradaScanner {
	...
	public static boolean EntradaParaRenovacao() {
		...
		do {
			...
			try {				
				...
				System.out.println("[1] Pegar armaduras novas - [2] Minhas armaduras atuais estão ótimas");
	...
	public static boolean EntradaParaAcabarComOCombate() {
		int opcao = 0;
		do {
			Scanner sc = new Scanner(System.in);
			try {				
				System.out.println("Faça a sua escolhar:");
				System.out.println("[1] Continuar com o combate - [2] Fugir da luta");
				System.out.print("Escrevendo: ");
				opcao = sc.nextInt();
				Utilitario.verificadorParaAcabarComOCombate(opcao);
			} catch (TextoInvalidoException tie) {
				System.err.println(tie.getMessage());
			}
		} while(Utilitario.combate);
		if (opcao == 1) {
			return false;
		} else {
			return true;
	...
	public static boolean EntradaParaPocao() {
		...
		do {
			...
			try {				
				System.out.println("Faça a sua escolhar:");
				System.out.println("[1] Usar poção da mesa - [2] Não preciso dessa poção");
				System.out.print("Escrevendo: ");
				opcao = sc.nextInt();
